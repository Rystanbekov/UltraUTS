///////////////////////////////////////////////////////////////////////////////
//                                                                            /
// IAR ANSI C/C++ Compiler V6.50.3.4676/W32 for ARM     01/Jun/2017  12:08:39 /
// Copyright 1999-2013 IAR Systems AB.                                        /
//                                                                            /
//    Cpu mode     =  thumb                                                   /
//    Endian       =  little                                                  /
//    Source file  =  Z:\Generator 8ch\IAR\system_stm32f10x.c                 /
//    Command line =  "Z:\Generator 8ch\IAR\system_stm32f10x.c" -D            /
...
//    List file    =  Z:\Generator 8ch\IAR\Debug\List\system_stm32f10x.s      /
//                                                                            /
//                                                                            /
///////////////////////////////////////////////////////////////////////////////
...
// Z:\Generator 8ch\IAR\system_stm32f10x.c
//    1 /**
//    2   ******************************************************************************
...
??SystemCoreClockUpdate_7:
        LDR.N    R3,??DataTable2_7  ;; 0x7a1200
        MUL      R3,R3,R1
        LDR.N    R4,??DataTable2_6
        STR      R3,[R4, #+0]
//  358         }
...
// 1055                                         RCC_CFGR_PLLMULL));
        ...
        LDR.N    R1,??DataTable2_1  ;; 0x40021004
        STR      R0,[R1, #+0]
// 1056     RCC->CFGR |= (uint32_t)(RCC_CFGR_PLLSRC_HSE | RCC_CFGR_PLLMULL16);
        LDR.N    R0,??DataTable2_1  ;; 0x40021004
        LDR      R0,[R0, #+0]
        ORRS     R0,R0,#0x390000
        LDR.N    R1,??DataTable2_1  ;; 0x40021004
